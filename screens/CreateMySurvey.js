...
const CreateMySurvey = ({navigation}) => {
  ...
  const moveNext=()=>{
    ...
    if(end=="Select End Date")
    {
      ...
      navigation.navigate('MySurveyQuestion',{Title:title,Audience:audience,StartDate:moment(start).format("MM-DD-YYYY"),EndDate:moment(end).format("MM-DD-YYYY")});
  }
}
  return (
